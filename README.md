  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card-deck">
          <div class="card">
            <img src="karela.jpeg" class="card-img-top" alt="Product 1">
            <div class="card-body">
          ...
          <div class="card">
            <img src="calcimax-forte-plus-tablet.jpg" class="card-img-top" alt="Product 2">
            <div class="card-body">
          ...
          <div class="card">
            <img src="kart.jpg" class="card-img-top" alt="Product 3">
            <div class="card-body">
